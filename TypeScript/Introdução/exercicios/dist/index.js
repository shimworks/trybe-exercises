...
let choiceMonth = readline_sync_1.default.keyInSelect(monthsNames, 'Escolha um mes do ano');
console.log(`Voce escolheu mes -------${choiceMonth}`);
const seasonsSouth = {
...
let choiceHemisphere = readline_sync_1.default.keyInSelect(Object.keys(hemispheres), 'Escolha um hemispherio');
console.log(`Voce escolheu hemisferio ------ ${choiceHemisphere}`);
