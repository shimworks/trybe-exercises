...
let choiceMonth = readline.keyInSelect(monthsNames, 'Escolha um mes do ano');
...
let choiceHemisphere = readline.keyInSelect(Object.keys(hemispheres), 'Escolha um hemispherio');
...
Object.entries(chosenHemisphereSeasons).map((entry) => {
  ...
  if (months.includes(month)) console.log(seasons, entry);
})
